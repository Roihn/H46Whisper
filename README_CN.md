...
仅供个人娱乐方便使用，参考[N46Whisper](https://github.com/Ayanaminn/N46Whisper)。

Language : [English](./README.md)  | 简体中文

H46Whisper 是基于 Google Colab 的应用。开发初衷旨在提高乃木坂46（以及坂道系）字幕组的工作效率。但本应用亦适于所有日语视频的字幕制作。
...
## 如何使用
* [点击这里](https://colab.research.google.com/github/Roihn/H46Whisper/blob/main/H46Whisper.ipynb) 在Google Colab中打开应用.
* 上传要识别的文件并运行应用
* 识别完成后ass文件会自动下载到本地.
